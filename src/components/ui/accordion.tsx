...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="overflow-hidden rounded-b-base bg-secondary text-sm font-base transition-all data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down"
      {...props}
    >
